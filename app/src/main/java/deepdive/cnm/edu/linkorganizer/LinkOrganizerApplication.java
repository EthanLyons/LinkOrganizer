 ...
 */
public class LinkOrganizerApplication extends Application {

  private static LinkOrganizerApplication instance = null;
   ...
   */
  public static LinkOrganizerApplication getInstance() {
    return instance;
  }
